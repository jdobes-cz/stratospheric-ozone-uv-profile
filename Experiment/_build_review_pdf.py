"""Convert Experiment/data_review.md to Experiment/data_review.pdf via
Python-Markdown + WeasyPrint CLI (same tool chain as paper.py).
"""
import shutil
import subprocess
import sys
...
MD = HERE / "data_review.md"
HTML = HERE / "data_review.html"
PDF = HERE / "data_review.pdf"
...
<head>
<meta charset="utf-8">
<title>Post-Flight Data Review — ASGARD-XV Exp 14</title>
<style>{CSS}</style>
</head>
<body>
{body}
